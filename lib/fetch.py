...
class Fetcher:
    ...
    async def fetch_html(self, source_key: str) -> dict:
        ...
        try:
            ...
            if scrape_result.status != "success" and scrape_result.status != "no_content":
                return {
                    "source": source_key,
                    "results": [],
            ...
            links = parse_source_links(scrape_result.html_path, source)
        ...
        async def _fetch_one(key: str) -> dict:
            async with self._semaphore:
                ...
                if source_type == "rss":
                    ...
                    return await self.fetch_html(key)
